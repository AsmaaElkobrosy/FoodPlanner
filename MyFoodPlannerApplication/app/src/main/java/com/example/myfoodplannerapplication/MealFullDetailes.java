...
@Entity(tableName= "Meals", primaryKeys = {"idMeal","email"})
public class MealFullDetailes {
    ...
    public MealFullDetailes(@NonNull String idMeal, String strMeal, String strCategory, String strArea, String strInstructions, String strMealThumb, String strYoutube) {
        this.idMeal = idMeal;
